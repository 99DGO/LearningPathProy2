...
public class MenuProfesor
{
	...
	public static void mostrarMenuEdicionActividad()
	{
		...
		try
        {
            ...
            System.out.println("8. Editar calificacion minima");
            System.out.println("9. Editar obligatoriedad");
            System.out.println("10. Añadir actividad prerequisito");
            System.out.println("11. Eliminar actividad prerequisito");
            System.out.println("12. Añadir actividad siguiente");
            System.out.println("13. Eliminar actividad siguiente");
            System.out.println("0. Salir");
            int opcion = scanner.nextInt();
            switch (opcion)
            {
            case 1:
                ...
                try
                {
                	EditorActividadGeneral.editNombre(IDCamino, IDActividad, nuevoTitulo);
                    System.out.println("Titulo editado exitosamente.\nNuevo titulo: " + nuevoTitulo + "\n");
                }
                catch (Exception e)
                {
            ...
            case 2:
                ...
                try
                {
                    EditorActividadGeneral.editDescripcion(IDCamino, IDActividad, nuevaDescripcion);
                    System.out.println(
                            "Descripcion editada exitosamente.\nNueva descripcion: " + nuevaDescripcion + "\n");
                }
                catch (Exception e)
            ...
            case 3:
				...
				try
				{
					EditorActividadGeneral.editDificultad(IDCamino, IDActividad, nuevaDificultad);
					System.out.println("Dificultad editada exitosamente.\nNueva dificultad: " + nuevaDificultad + "\n");
				}
				catch (Exception e)
				{
            ...
            case 4:
				...
				try
				{
					EditorActividadGeneral.editDuracion(IDCamino, IDActividad, nuevaDuracion);
					System.out.println("Duracion editada exitosamente.\nNueva duracion: " + nuevaDuracion + "\n");
				}
				catch (Exception e)
				{
            ...
            case 5:
            	...
            	try
				{
					EditorActividadGeneral.editAddObjetivo(IDCamino, IDActividad, nuevoObjetivo);
					System.out.println("Objetivo añadido exitosamente.\nObjetivo añadido: " + nuevoObjetivo + "\n");
				}
				catch (Exception e)
				{
            ...
            case 6:
            	...
            	try
				{
					EditorActividadGeneral.editDelObjetivo(IDCamino, IDActividad, objetivoEliminar);
					System.out.println("Objetivo eliminado exitosamente.");
				}
				catch (Exception e)
				{
            ...
            case 7:
            	...
            	try
            	{
					EditorActividadGeneral.editFechaLim(IDCamino, IDActividad, fechaLimite);
					System.out.println(
            ...
            case 8:
            	...
            	scanner.nextLine();
            	Float nuevaCalificacion = scanner.nextFloat();
            	try
            	{
            		EditorActividadGeneral.editCalifMin(IDCamino, IDActividad, nuevaCalificacion);
            	}
